...
export const CAPI_DA_RICONOSCERE: CapoDaRiconoscere[] = [
  {
    ...
    riconosciuto: {
      category: "top",
      subcategory: "felpa col cappuccio",
      colors: ["beige"],
  ...
  {
    slug: "sneakers-marroni",
    etichetta: "Delle sneakers",
    riconosciuto: {
      category: "scarpe",
      subcategory: "sneakers con suola spessa",
      colors: ["marrone", "beige"],
